import { Button, HStack, VStack,Stack,Heading,Text,Image,Box} from "@chakra-ui/react";
...
const ProductItem=(props)=>{
   ...
   return(
    <Stack gap="0px" maxW="400px" p="10px" spacing="0px" direction={"column"} justifyContent={"left"} textAlign="left">
        ...
        <Button _hover={{color:"rgb(240,224,199)"}} maxW={"40%"} borderRadius={"0px"} color="rgb(240,224,199)" bgColor="rgb(0,18,51)" m="auto" onClick={handleCart}>Add</Button>
    </Stack>
   )
}
