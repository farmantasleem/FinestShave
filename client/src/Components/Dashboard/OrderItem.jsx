...
const OrderItem=(props)=>{
   ...
   return(
    <Stack gap="10px" maxW="400px" p="10px" spacing="0px" direction={"column"} justifyContent={"left"} textAlign="left">
        ...
        <Button _hover={{color:"rgb(240,224,199)"}} borderRadius={"0px"}  color="rgb(240,224,199)" bgColor="rgb(0,18,51)" disabled={status=="Cancelled"} onClick={()=>{dispatch(CancelOrder({productId,orderId}))}}>Cancel Request</Button>
    </Stack>
   )
}
