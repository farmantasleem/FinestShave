...
export const getAdminData=()=>{
    return async (dispatch,getState)=>{
        const userId=localStorage.getItem("TOKEN")
            try{
                const resp=await fetch("https://finestshave.onrender.com/admin/admindata",{
                    method:"GET",
...
export const roleSwitch=(id,toast)=>{
    return async(dispatch,getState)=>{
        const userId=localStorage.getItem("TOKEN");
        try{
            const resp=await fetch(`https://finestshave.onrender.com/admin/user/${id}`,{
                method:"PATCH",
                headers:{"Content-type":"application/json","authorization":`bearer ${userId}`},
            });
            toast({
...
export const deleteCartItem=(id,toast)=>{
    return async(dispatch,getState)=>{
        const userId=localStorage.getItem("TOKEN")
        try{
            const resp=await fetch(`https://finestshave.onrender.com/admin/cart/${id}`,{
                method:"DELETE",
                headers:{"Content-type":"application/json","authorization":`bearer ${userId}`},
            });
            toast({
...
export const deleteProduct=(id,toast)=>{
    return async(dispatch,getState)=>{
        const userId=localStorage.getItem("TOKEN")
        try{
            const resp=await fetch(`https://finestshave.onrender.com/admin/product/${id}`,{
                method:"DELETE",
                headers:{"Content-type":"application/json","authorization":`bearer ${userId}`},
            });
            toast({
...
export const deleteOrder=(id,toast)=>{
    return async(dispatch,getState)=>{
        const userId=localStorage.getItem("TOKEN")
        try{
            const resp=await fetch(`https://finestshave.onrender.com/admin/order/${id}`,{
                method:"DELETE",
                headers:{"Content-type":"application/json","authorization":`bearer ${userId}`},
            });
            toast({
...
export function AddProduct(data,toast){
    return async function (dispatch,getState){
        const userId=localStorage.getItem("TOKEN")
          try{
            const sendData=await fetch("https://finestshave.onrender.com/admin/product",{
                method:"POST",
